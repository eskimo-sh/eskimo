...
public class FileUtilsTest {
    ...
    public void testPathManip() {
        ...
        assertThrows(IllegalArgumentException.class, () -> FileUtils.slashEnd(null));
        assertThrows(IllegalArgumentException.class, () -> FileUtils.slashStart(null));
        assertThrows(IllegalArgumentException.class, () -> FileUtils.noSlashStart(null));
        assertThrows(IllegalArgumentException.class, () -> FileUtils.noSlashEnd(null));
    }
