...
public class ElasticSearchSetupTest extends AbstractSetupShellTest {
    ...
    protected void copyScripts(String jailPath) throws IOException {
        ...
        copyFile("elasticsearch", jailPath, "common.sh");
        copyFile("elasticsearch", jailPath, "setupESCommon.sh");
        copyFile("elasticsearch", jailPath, "inContainerSetupElasticSearch.sh");
        copyFile("elasticsearch", jailPath, "inContainerSetupESCommon.sh");
        copyFile("elasticsearch", jailPath, "inContainerStartService.sh");
        copyFile("elasticsearch", jailPath, "inContainerInjectTopology.sh");
    }
