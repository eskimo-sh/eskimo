...
public class FlinkCliWrappersTest extends AbstractSetupShellTest {
    ...
    public void testSQLClientSh() throws Exception {
        createScript("test-sqlclient.sh",
        ...
        String kubeNSFile = dockerLogs.substring(indexOfMount, dockerLogs.indexOf(",target=", indexOfMount));
        assertEquals ("run " +
                "-i " +
                "--rm " +
                "--network host " +
    ...
    public void testPyFlinkShellSh() throws Exception {
        createScript("test-pyflink-shell.sh",
    ...
    public void testFlink() throws Exception {
        createScript("test-flink.sh", "flink --jarfile /var/lib/eskimo/flink-demo.jar -p /var/cache/eskimo --savepointPath /tmp ch.niceideas.eskmo-TestFlink");
    ...
    public static void createScript(String scriptName, String command) throws FileException {
