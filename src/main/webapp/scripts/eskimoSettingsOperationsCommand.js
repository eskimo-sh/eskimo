...
eskimo.SettingsOperationsCommand = function(constructorObject) {
    ...
    this.initialize = function() {
        ...
        $("#settings-operations-command-modal-wrapper").load("html/eskimoSettingsOperationsCommand.html", function (responseTxt, statusTxt, jqXHR) {
    ...
    function showCommand (command) {
        ...
        // installations
        commandDescription += "<b>Settings Changes</b><br><br>";
        ...
        // restarts
        commandDescription += "<b>Services to be restarted</b><br><br>";
