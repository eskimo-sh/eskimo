...
"serviceX" : {
  ...
  "ui": {
    ...
    ## Whether standard rewrite rules need to be applied to this service
    "applyStandardProxyReplacements": false,

    ## List of custom rewrite rules for proxying of web consoles
    "proxyReplacements" : [
...
Proxying is however much more complicated to set up since eskimo needs to perform a lot of rewriting on the text
...
*TODO Explain rewrite rule.*

*TODO Explain standard rewrite rules*

*TODO Explain custom rewrite rules*

*TODO Explain patterns such as CONTEXT_PATH, PREFIX_PATH and detail available patterns*
