...
* An eskimo package has to provide a systemd unit configuration file to enable eskimo to operate the component on the cluster.
...
installation on every node) `/usr/local/sbin/handle_gluster_share.sh` in the following way, for instance to define
 the _flink data_ share : `/usr/local/sbin/handle_gluster_share.sh flink_data /var/lib/flink/data flink`
...
* *gluster* - neglectable
* *mesos agent* - neglectable
* *elasticsearch* - large
* *logstash* - small
* *kafka* - medium
* *(spark executor)* - large
* *(flink worker)* - medium
...
| *gluster*           |  -    |  -    |  -
| *mesos agent*       |  -    |  -    |  -
| *elasticsearch*     | 1359m | 2736m | 3465m
| *logstash*          |  453m |  912m | 1155m
| *kafka*             |  906m | 1824m | 2310m
| *(spark executor)*  | 1359m | 2736m | 3465m
| *(flink worker)*    |  906m | 1824m | 2310m
| *zookeeper*         |  -    |  -    |  -
| *kibana*            |  453m |  912m | 1155m
| *zeppelin*          |  453m |  912m | 1155m
| *_Filesystem cache reserve_*  | 1359m | 2736m | 3465m
|===================
