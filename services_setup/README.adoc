...
"serviceX" : {
  ...
  "config": {
    ...
    ## [mandatory] name of the service. miust be consistend with service under
    ## 'service_setup'
    "name" : "{service name},
...
circular way (pretty nifty for instance for elasticsearch discovery).)
