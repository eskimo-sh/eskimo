...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: prometheus
          image: kubernetes.registry:5000/prometheus:$(get_last_tag prometheus)
          ...
          resources:
            requests:
              cpu: "$ESKIMO_KUBE_REQUEST_PROMETHEUS_CPU"
              memory: "$ESKIMO_KUBE_REQUEST_PROMETHEUS_RAM"
      volumes:
        - name: var-log-prometheus
          hostPath:
