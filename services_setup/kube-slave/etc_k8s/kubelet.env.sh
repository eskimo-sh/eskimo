...
export ESKIMO_KUBELET_CGROUP_DRIVER="cgroupfs"
...
export ESKIMO_KUBELET_NETWORK_PLUGIN_DIR=/opt/cni/bin
echo "   + Using ESKIMO_KUBELET_NETWORK_PLUGIN_DIR=$ESKIMO_KUBELET_NETWORK_PLUGIN_DIR"

export ESKIMO_KUBELET_NETWORK_PLUGIN=cni
echo "   + Using ESKIMO_KUBELET_NETWORK_PLUGIN=$ESKIMO_KUBELET_NETWORK_PLUGIN"

export ESKIMO_KUBELET_CNI_CONF_DIR=/etc/cni/net.d/
echo "   + Using ESKIMO_KUBELET_CNI_CONF_DIR=$ESKIMO_KUBELET_CNI_CONF_DIR"

export ESKIMO_KUBELET_POD_INFRA_CONTAINER_IMAGE="kubernetes.registry:5000/k8s.gcr.io/pause"
echo "   + Using ESKIMO_KUBELET_POD_INFRA_CONTAINER_IMAGE=$ESKIMO_KUBELET_POD_INFRA_CONTAINER_IMAGE"
