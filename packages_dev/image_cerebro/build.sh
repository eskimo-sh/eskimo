...
docker exec -i cerebro_template apt-get install -y openjdk-11-jdk-headless  > /tmp/cerebro_build_log 2>&1
...
check_in_container_install_success /tmp/cerebro_build_log
