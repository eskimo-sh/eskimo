...
* *https://www.eskimo.ch/eskimo/V0.4/eskimo_packages_versions.json*
* https://www.eskimo.ch/eskimo/V0.4/docker_template_base-eskimo_0.2_1.tar.gz
* https://www.eskimo.ch/eskimo/V0.4/docker_template_cerebro_0.8.4_1.tar.gz
* https://www.eskimo.ch/eskimo/V0.4/docker_template_elasticsearch_6.8.3_1.tar.gz
* https://www.eskimo.ch/eskimo/V0.4/docker_template_flink_1.9.1_2.tar.gz
* https://www.eskimo.ch/eskimo/V0.4/docker_template_gluster_debian_09_stretch_1.tar.gz
* etc.
* https://www.eskimo.ch/eskimo/V0.4/eskimo_kube_1.23.5_1.tar.gz
