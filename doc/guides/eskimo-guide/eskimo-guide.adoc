...
Cerebro is used to administer monitor elasticsearch nodes and activities.

==== Elastic Kibana

Kibana is a data Visualization tool designed to plug on ElasticSearch

==== Apache Kafka

Kafka is a distributed and low-latency data distribution and processing framework

==== Kafka Manager

Kafka Manager is used to administer and monitor kafka nodes and topics.

==== Apache Mesos

Mesos is used to manage cluster nodes resources and distribute spark workload.

==== Apache Spark

Spark is a very versatile Big Data Processing engine.
...
Zeppelin is a development tool and application to design Big Data Processing Jobs.
...
Grafana is a Data visualization tool aimed at visualiting Prometheus raw data
