...
* A _plug and pla_y, working _out of the Box_, *Big Data Analytics platform* fulfilling _enterprise environment
requirements_.
...
include::../../../services_setup/README.adoc[leveloffset=0,lines=60..650]
