...
:sectnums:
:toc:
:authors: eskimo.sh - https://www.eskimo.sh - 2019-2022
:copyright: eskimo.sh - https://www.eskimo.sh - 2019-2022
...
include::../../../packages_dev/README.adoc[leveloffset=0,lines=80..340]



// included service developer README

include::../../../services_setup/README.adoc[leveloffset=0,lines=80..1000]
